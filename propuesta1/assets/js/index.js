...
class SplitTextJS {
  constructor(_target) {
    ...
    this.result.words = this.result.splitted.getElementsByClassName(
      ".SplitTextJS-wrapper"
    );
    this.result.chars =
      this.result.splitted.getElementsByClassName(".SplitTextJS-char");
    this.result.spaces = this.result.splitted.getElementsByClassName(
      ".SplitTextJS-spacer"
    );
    return this.result;
  }
